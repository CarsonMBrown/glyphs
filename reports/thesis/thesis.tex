...
\thesistitle{Automated Optical Detection and Recognition of Greek Letters on Degraded Papyrus} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
