...
total_img_patches, total_msk_patches = [], []  # patches for all the figures or ground truths
...
for idx in range(len(img_list)):
    ...
    # extract the patches from the original document figures and the corresponding ground truths
