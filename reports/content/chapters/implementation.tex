...
\begin{figure}[H]
    ...
    \begin{center}
      \begin{subfigure}[b]{0.45\textwidth}
       ...
       \end{subfigure}
    \end{center}
    Two examples of clustering pixels using RGB color representation to place each pixel in space. These clusterings were generated using K-means Clustering with $k=3$, with each cluster being displayed by the color represented by the location in RGB space of the cluster's centroid.
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{center}
        \includegraphics[width=\textwidth]{{misc/connectivity.png}}
  \end{center}
...
\begin{figure}[H]
  ...
  \begin{center}
        \includegraphics[width=\textwidth]{{bounding/cc/G_26734_c_crop.png}}
  \end{center}
...
Once lines are formed, they can also be used to modify bounding boxes to fix issues such as a bounding box covering two glyphs, or one glyph being covered by two bounding boxes \seefig{boundingErrors}.
