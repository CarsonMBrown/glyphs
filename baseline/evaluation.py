...
def main():
    with open(os.path.join(os.path.join("output", "HomerCompTestingCoco.json")), encoding="UTF-8") as jFile:
        predictions = json.load(jFile)

    with open(os.path.join(os.path.join("output", "GT.json")), encoding="UTF-8") as jFile:
        gt = json.load(jFile)
